<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Biometrics_Display.aspx.cs" Inherits="Display_Biometrics_Display" %>
...
<head runat="server">
    ...
    <title>RTO CUTTACK : Biometrics Display</title>
        ...
        <div id="wrap" class="animsition">
            <div class="page page-core page-login">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="text-left">
                            <h1 class="h1-class">Welcome To Biometrics Display</h1>
                            <h1 class="h1-class">ବାୟୋମେଟ୍ରିକ୍ସ  ପ୍ରଦର୍ଶନକୁ ସ୍ୱାଗତ </h1>
                            |
                        ...
                        <section class="tile bg-blue portlet">
                            ...
                            <div class="tile-body h">
                                <div class="text-center">
                                    ...
                                    <strong class="st-class12">20</strong>
                                </div>
                            </div>
                        </section>
                    </div>
                        ...
                        <section class="tile bg-lightred portlet">
                            ...
                            <div class="tile-body h">
                                <div class="text-center">
                                    <strong class="st-class1">Learners License(LL)</strong><br />
                                    <strong class="st-class1">Token Number</strong><br />
                                    <strong class="st-class12">521</strong>
                        ...
                        <section class="tile bg-orange portlet">
                            ...
                            <div class="tile-body h">
                                <div class="text-center">
                                    <strong class="st-class1">Learners License(LL)</strong><br />
                                    <strong class="st-class1">Token Number</strong><br />
                                    <strong class="st-class12">67</strong>
                                </div>
                            </div>
                        </section>
                    </div>
                        ...
                        <section class="tile bg-green portlet">
                            ...
                            <div class="tile-body h">
                                <div class="text-center">
                                    <strong class="st-class1">Learners License(LL)</strong><br />
                                    <strong class="st-class1">Token Number</strong><br />
                                    <strong class="st-class12">1</strong>
                                </div>
                            </div>
                        </section>
                    </div>
